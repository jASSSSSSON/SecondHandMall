...
<body>
	...
	<p>
		<a target="_blank"
			href="http://ica1.gdcp.cn/web/loadWebPage.do?1_649_44015038150_3">930工作室</a>&nbsp;版权所有&nbsp;2020
	</p>
	</footer>
    ...
    function addFirstType() {
        ...
        $.ajax({
            type:"POST",
            url:"${pageContext.request.contextPath }/type/firstType/create",
    ...
    function deleteFirst(first_id) {
        $.getJSON("${pageContext.request.contextPath }/type/firstType/delete/"+first_id, function (data) {
            if (data === false){
    ...
    function deleteSecond(second_id) {
        $.getJSON("${pageContext.request.contextPath }/type/secondType/delete/"+second_id, function (data) {
            if (data === false){
    ...
    function firstButton(first_id) {
        ...
        $.getJSON("${pageContext.request.contextPath }/type/secondType/"+first_id, function (data) {
            if (data === false){
                alert("好像出了问题，请重试！")
            } else if (data === "isNull") {
                alert("该分类下暂无分类！")
    ...
    function setUserStatus(statusId, userId) {
        $.getJSON("${pageContext.request.contextPath }/admin/user/update/status/"+statusId+"&"+userId, function (data) {
            if (data === false){
                alert("用户状态修改失败！");
            } else {
    ...
    function delUser(userId) {
        $.getJSON("${pageContext.request.contextPath }/admin/user/delete/"+userId, function (data) {
            if (data === false){
                alert("用户删除失败！");
            } else {
                document.getElementById("userTable").innerHTML = "";
    ...
    function delOrder(orderId) {
        $.getJSON("${pageContext.request.contextPath }/user/order/delete/"+orderId, function (data) {
            if (data){
                $.getJSON("${pageContext.request.contextPath }/user/order/allOrder", function (data) {
    ...
    function delGood(goodId) {
        $.getJSON("${pageContext.request.contextPath }/goods/userGoodEdit/delete/"+goodId, function (data) {
            if (data){
                $.getJSON("${pageContext.request.contextPath }/admin/goods/allGoods", function (data) {
    ...
    function setStatus(goodId) {
        $.getJSON("${pageContext.request.contextPath }/goods/userGoodEdit/updateGoodStatus/"+goodId, function (data) {
            if (data){
                $.getJSON("${pageContext.request.contextPath }/admin/goods/allGoods", function (data) {
                    document.getElementById("goodTable").innerHTML = "";
                    $.each(data, function (i, type) {
