...
<body>
				...
				<div class="col-md-12" style="margin-top: 40px;">
					...
					<div class="col-md-5">
						...
						<div class="col-md-12" style="padding: 0;">
							<div class="col-md-5 r-c" style="display: ${sessionScope.user.id == goodInfo.goodUser.id ? 'none':''}">
								<a href="${basePath}/comm/userChat?id=${goodInfo.goodUser.id}"><B style="font-size: 20px; color: #e2e2e2">联系卖家</B></a>
							</div>
						...
						<div class="col-md-12" style="margin-top: 50px" align="right">
							<p>
								<a
									href="${pageContext.request.contextPath }/goods/userGoods?userId=${goodInfo.userId}">查看卖家其他物品</a>
							</p>
						</div>
					</div>
				</div>
						...
						<c:forEach var="review" items="${reviews}">
							<div class="col-md-12 r"
								...
								<div id="${review.id}" class="col-md-12"
									...
									<form action="${pageContext.request.contextPath }/goods/goodInfo" method="post">
										<div class="col-sm-10">
					...
					<a target="_blank" href="goodInfo?goodId=${good.id}">
						<div class="col-md-12 b"
							...
							<div class="col-md-6"
								...
								<img src="${pageContext.request.contextPath }/<c:url value="${good.photoUrl}"/>" height="100px"
									; width="100px">
							</div>
    ...
    function collect() {
        ...
        $.ajax({
            type:"POST",
            url:"${pageContext.request.contextPath }/collect/insert",
            ...
            success:function (data) {
                if (data === false){
                    ...
                    alert("收藏成功！");
                    $(window).attr('location','${pageContext.request.contextPath }/goods/goodInfo?goodId=${goodInfo.id}');
                }
            }
        })
    }
            ...
            $.ajax({
                ...
                success:function (data) {
                    if (data === false){
                        ...
                        $(window).attr('location','${pageContext.request.contextPath }/user/orderInfo?orderId=' + data);
                    }
                }
            });
        }
