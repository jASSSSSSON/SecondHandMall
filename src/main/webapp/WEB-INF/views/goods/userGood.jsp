					...
					<c:choose>
						...
						<c:otherwise>
							<c:forEach var="userGood" items="${userGoods}">
								<a target="_blank"
									href="${pageContext.request.contextPath }/goods/goodInfo?goodId=${userGood.id}">
									<div class="c col-md-4">
										<div class="a col-md-12">
											<img src="${pageContext.request.contextPath }/<c:url value="${userGood.photoUrl}"/>" width="100%">
											<p></p>
		...
		<div id="re-bar" class="col-md-3 r"
			...
			<div class="col-md-12"
				...
				<c:forEach var="Good" items="${goods}">
					<a target="_blank"
						href="${pageContext.request.contextPath }/goods/goodInfo?goodId=${Good.id}">
