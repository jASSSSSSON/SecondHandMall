		...
		<div class="main-content">
			...
			<div class="col-md-10" style="margin-top: 10px; float: right;">
				...
				<c:forEach var="good" items="${goods}">
					<a target="_blank" href="${pageContext.request.contextPath }/goods/goodInfo?goodId=${good.id}">
...
<script type="text/javascript" src="<c:url value="/statics/jquery-1.12.4/jquery-1.12.4.js"/>"></script>
<script type="text/javascript" src="<c:url value="/statics/bootstrap-3.3.0/js/bootstrap.js"/>"></script>
<script type="text/javascript" src="<c:url value="/statics/jquery-ui-1.12.1/jquery-ui.js"/>"></script>
<script type="text/javascript" src="<c:url value="/statics/jquery-ui-1.12.1/datepicker-zh-CN.js"/>"></script>
</html>