...
<body>
		...
		<div class="col-md-9" style="float: left">
			...
			<div class="col-md-12 r2"
				...
				<div class="col-md-2" style="padding-left: 0px; padding-right: 0px;">
					<img src="${pageContext.request.contextPath }/<c:url value="${sessionScope.user.photoUrl}"/>"
										...
										<c:forEach var="collect" items="${collects}">
											<tr style="color: #666666">
												<td style="width: 102px"><a target="_blank"
													href="${pageContext.request.contextPath }/goods/goodInfo?goodId=${collect.good.id}">${collect.good.id}</a></td>
										...
										<c:forEach var="order" items="${orders}">
											<tr style="color: #666666">
												<td style="width: 90px"><a target="_blank"
													href="${pageContext.request.contextPath }/user/orderInfo?orderId=${order.id}">${order.id}</a></td>
					...
					<c:choose>
						...
						<c:otherwise>
							<c:forEach var="review" items="${reviews}">
								<a target="_blank"
									href="${pageContext.request.contextPath }/user/review?goodId=${review.goodId}&reviewId=${review.id}">
					...
					<c:choose>
						...
						<c:otherwise>
							<c:forEach var="reply" items="${replies}">
								<a target="_blank"
									href="${pageContext.request.contextPath }/user/reply?reviewId=${reply.reviewId}&replyId=${reply.id}">
									<div class="col-md-12 rev"
										style="padding-left: 0px; padding-right: 0px; margin-bottom: 5px;">
										<div class="col-md-11">
											<p></p>
						...
						<c:choose>
							...
							<c:otherwise>
								<c:forEach var="sellGood" items="${sellGoods}">
									<a
										href="${pageContext.request.contextPath }/user/sellerInfo?orderId=${sellGood.id}">
										<div class="col-md-12 rev"
    ...
    function deleteCollect(collectId) {
        $.get("${pageContext.request.contextPath }/collect/delete/"+collectId+"&"+${sessionScope.user.id}, function (data) {
            if (data === false){
                alert("未知原因，删除失败！");
            } else {
