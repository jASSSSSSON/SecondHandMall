			...
			<c:choose>
				...
				<c:otherwise>
					<c:forEach var="order" items="${orders}">
						<a href="${pageContext.request.contextPath }/user/orderInfo?orderId=${order.id}">
...
<script>
    ...
    function deleteOrder() {
        $.getJSON("${pageContext.request.contextPath }/user/order/delete/" + ${orderInfo.id}, function (data) {
            if (data == true){
                alert("订单删除成功！");
